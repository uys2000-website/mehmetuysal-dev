<template>
  <div class="h-full w-full  min-w-full flex overflow-hidden prose">
    ...
    <Head>
      <title>Privacy Policy for UMorse</title>
      <Meta name="description" content="Privacy Policy for UMorse" />
    </Head>
    <div
      ...
      <p>At UMorse, accessible from https://umorse.mehmetuysal.dev, one of our main priorities is the privacy of our
        visitors. This Privacy Policy document contains types of information that is collected and recorded by UMorse and
        how we use it.</p>
      ...
      <p>UMorse follows a standard procedure of using log files. These files log visitors when they visit websites. All
      ...
      <p>You may consult this list to find the Privacy Policy for each of the advertising partners of UMorse.</p>

      <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
        their respective advertisements and links that appear on UMorse, which are sent directly to users' browser. They
      ...
      <p>Note that UMorse has no access to or control over these cookies that are used by third-party advertisers.</p>

      <h2>Third Party Privacy Policies</h2>

      <p>UMorse's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the
      ...
      <p>UMorse does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you
      ...
      <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
        to the information that they shared and/or collect in UMorse. This policy is not applicable to any information
