<template>
  <div class="h-full w-full  min-w-full flex overflow-hidden prose">

    <Head>
      <title>Privacy Policy for Mehmet Uysal</title>
      <Meta name="description" content="Privacy Policy for Mehmet Uysal" />
    </Head>
    <div
      class="h-full w-full min-w-full overflow-y-auto modal-box translations-content-item en relative bg-white p-5 bg-opacity-50">
      <h1>Privacy Policy for Mehmet Uysal</h1>

      <p>At Mehmet Uysal, accessible from https://mehmetuysal.dev, one of our main priorities is the privacy of our
        visitors. This Privacy Policy document contains types of information that is collected and recorded by Mehmet
        Uysal and how we use it.</p>
      ...
      <p>Mehmet Uysal follows a standard procedure of using log files. These files log visitors when they visit websites.
      ...
      <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Mehmet Uysal.</p>

      <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
        their respective advertisements and links that appear on Mehmet Uysal, which are sent directly to users' browser.
      ...
      <p>Note that Mehmet Uysal has no access to or control over these cookies that are used by third-party advertisers.
      </p>

      <h2>Third Party Privacy Policies</h2>

      <p>Mehmet Uysal's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
      ...
      <p>Mehmet Uysal does not knowingly collect any Personal Identifiable Information from children under the age of 13.
      ...
      <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
        to the information that they shared and/or collect in Mehmet Uysal. This policy is not applicable to any
